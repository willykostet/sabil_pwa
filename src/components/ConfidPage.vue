...
Конфиденциальность</div></a>
<router-link to="/main"><ul >
  <li> <img src="../assets/switchoff.svg" alt="">   Использовать при входе функцию <b>Face ID</b> </li>
  <li> <img src="../assets/switchoff.svg" alt="">   Использовать при входе функцию <b>Face ID</b> </li>
   <li> <img src="../assets/Switch.svg" alt="">    Использовать при входе <b>пароль</b></li>
</ul></router-link>
