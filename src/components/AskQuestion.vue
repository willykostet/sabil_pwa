...
<header style="display: flex; justify-content:space-between;">
  ...
  <div class="controls" style="display: flex">
    ...
    <img src="../assets/Gear.svg" alt="" class="header-icon"></router-link>
...
<label for="">Ваш вопрос <textarea name="" id="" cols="30" rows="20"></textarea></label>

    
    <input class="file-input" style="box-shadow: none; width: 300px;" type="file">
