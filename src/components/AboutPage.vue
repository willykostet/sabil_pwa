...
<img src="../assets/about-logo.svg" style="margin: 3% auto" alt="">
<p style="font-size: 9px; padding: 5%; text-align:left;
line-height: 11px;color: #000000;text-transform: capitalize;
">Donec at eros hendrerit, tempor felis quis, facilisis dui. Donec sed placerat dui, ut convallis nibh. Curabitur rutrum laoreet libero, nec scelerisque orci gravida non. Donec imperdiet convallis leo, non hendrerit diam fringilla non. Etiam egestas vehicula pharetra. In fermentum malesuada efficitur. Maecenas id dapibus ipsum. Donec et sapien vitae metus varius lobortis. Duis libero turpis, euismod eu congue quis, euismod ut massa. Ut eget lectus tempus, pellentesque tellus non, consequat ex.
<br>
<br>
Aenean tincidunt mauris nec ipsum laoreet dapibus. Integer et blandit justo. Ut egestas, diam ut ornare rhoncus, est metus blandit libero, id sodales augue metus et sapien. Praesent a varius ante, sed sodales nibh. Maecenas pharetra posuere sapien, nec sodales velit efficitur a. Vestibulum at nisi sagittis, aliquet sem vitae, elementum sapien. Suspendisse in efficitur risus. Phasellus porta non neque in dapibus. Duis aliquam facilisis vulputate.
</p>
...
<div class="right">  
 <router-link to="/calend"><img src="../assets/calend-active.svg" alt="" class="footer-calend footer-icon" @click="openCalend()"></router-link>
