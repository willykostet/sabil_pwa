...
<p>Доступно в текущем тарифном плане</p></div>


   <div class="div" style="display:flex;gap:10px; flex-direction: column; margin-top: 10%;">  <div style="display:flex; justify-content: space-between;" >
          <p style="font-family: 'Montserrat';
font-style: normal;
font-weight: 400;
font-size: 10px;
line-height: 12px;color: #000000;">Роуминг<b style="margin-left:5px">150 р/мес</b></p>
...
font-weight: 400;
font-size: 10px;
line-height: 12px;color: #000000;">Родительский контроль  <b>150 р/мес</b></p>
          <p @click="showModal=true" style="font-family: 'Montserrat';
font-style: normal;
font-weight: 500;
font-size: 10px;
