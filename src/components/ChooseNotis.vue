...
Настройка уведомлений</div></a>
<router-link to="/main"><ul >
  <li> <img src="../assets/switchoff.svg" alt="">   Внесение абонентской платы</li>
  <li> <img src="../assets/Switch.svg" alt="">  Внесение абонентской платы</li>
   <li> <img src="../assets/Switch.svg" alt="">   Внесение абонентской платы</li>
  <li> <img src="../assets/switchoff.svg" alt="">  Внесение абонентской платы</li>
 <li> <img src="../assets/Switch.svg" alt="">   Внесение абонентской платы</li>
  <li> <img src="../assets/Switch.svg" alt="">  Внесение абонентской платы</li>
